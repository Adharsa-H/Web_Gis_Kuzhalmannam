...
map.getView().fit([8504134.549972, 1187862.963115, 8546473.035482, 1208166.033908], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Kuzhalmannam Web GIS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (76 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'As part of MSc Programme, this website is created using Open Source Software';
            }
